...
import static saf.settings.AppPropertyType.LOAD_COMPLETED_MESSAGE;
import static saf.settings.AppPropertyType.LOAD_COMPLETED_TITLE;
	...
	PropertiesManager props = PropertiesManager.getPropertiesManager();
		...
		File selectedFile = fc.showSaveDialog(app.getGUI().getWindow());
                ...
                if(!selectedFile.getName().contains(".")) {
                  selectedFile = new File(PATH_WORK + selectedFile.getName() + ".html");
                }
                */
